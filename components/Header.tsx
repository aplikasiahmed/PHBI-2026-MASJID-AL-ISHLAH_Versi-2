...
const Header: React.FC<HeaderProps> = ({ onLoginClick }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#005fe0] text-white shadow-lg border-b-4 border-gold">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center gap-3">
        ...
        <button 
          ...
          className="bg-[#005fe0] hover:bg-[#004bb3] text-white px-3 py-2 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-bold transition flex-shrink-0 flex items-center gap-2 shadow-md border border-[#004bb3]"
        >
